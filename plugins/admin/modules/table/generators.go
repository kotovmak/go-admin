...
import (
	...
	"github.com/kotovmak/go-admin/modules/collection"
	"github.com/kotovmak/go-admin/modules/config"
	"github.com/kotovmak/go-admin/modules/db"
	"github.com/kotovmak/go-admin/modules/db/dialect"
	errs "github.com/kotovmak/go-admin/modules/errors"
	"github.com/kotovmak/go-admin/modules/language"
	"github.com/kotovmak/go-admin/modules/logger"
	"github.com/kotovmak/go-admin/modules/ui"
	...
	"github.com/kotovmak/go-admin/plugins/admin/modules/tools"
	"github.com/kotovmak/go-admin/template"
	"github.com/kotovmak/go-admin/template/types"
	"github.com/kotovmak/go-admin/template/types/action"
	"github.com/kotovmak/go-admin/template/types/form"
	selection "github.com/kotovmak/go-admin/template/types/form/select"
...
func (s *SystemTable) GetGenerateForm(ctx *context.Context) (generateTool Table) {
	...
	formList.AddField(lgWithScore("extra import package", "tool"), "extra_import_package", db.Varchar, form.Select).
		FieldOptions(types.FieldOptions{
			...
			{Text: "log", Value: "log"},
			{Text: "fmt", Value: "fmt"},
			{Text: "github.com/kotovmak/go-admin/modules/db/dialect", Value: "github.com/kotovmak/go-admin/modules/db/dialect"},
			{Text: "github.com/kotovmak/go-admin/modules/db", Value: "github.com/kotovmak/go-admin/modules/db"},
			{Text: "github.com/kotovmak/go-admin/modules/language", Value: "github.com/kotovmak/go-admin/modules/language"},
			{Text: "github.com/kotovmak/go-admin/modules/logger", Value: "github.com/kotovmak/go-admin/modules/logger"},
		}).
		FieldDefault("").
